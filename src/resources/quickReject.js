const data = {
    "Spam": {
        "No content / Default project": "Your project was rejected because you uploaded a project with content that either does nothing or is not there. Snail IDE only approves projects with actual block code or art you drew.",
    ...
    "Scratch Reupload": "Your project was rejected because it is the same as the version you uploaded to Scratch. Please add more content or plan to add some unique features to Snail IDE.",
    ...
    "Be respectful to others": {
        "Misuse of an external platform": "Your project was rejected because it links to a platform that is not safe for Snail IDE to share. Please link to another source or remove inappropriate links.",
        ...
        "Offensive / Extreme Content": {
            "Gore": "Your project was rejected because it contains realistic or extreme amounts of gore (Shows real or realistic blood, guts or death). Keep in mind that Snail IDE is available for users under 13, do not use Snail IDE as a facet to upload inappropriate content to.",
            "Drugs / Illegal material": "Your project was rejected because it contains references to drug and/or otherwise illegal material. Please do not use Snail IDE as a facet to upload illegal content, and we may involve authorities if severe enough.",
            "Pornography / Disturbing / Sexual or explicit content": "Your project was rejected because it contains sexual, explicit or disturbing content not safe for users under 18. Keep in mind that Snail IDE wants to be available for all ages and we will punish users who use Snail IDE as a facet to upload inappropriate content.",
            "Pornography: Inflation / Vore / Fetish content": "Your project was rejected because it contains explicit or disturbing content not safe for all ages. Keep in mind that Snail IDE wants to be available for all ages and we will punish users who use Snail IDE as a facet to upload inappropriate content.",
            "Discriminatory Content": "Your project was rejected because it discriminates to a certain group or groups. Snail IDE would like to stay inclusive of all groups on our platform, and we may punish your account for breaking this guideline.",
            "Threat": "Your project was removed because it threatens other users or a group of people. Snail IDE does not allow this behavior, and we may punish your account if severe enough.",
